...
export default function SalesDeckCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <header style={{ padding: "1.5rem" }}>
        <div className="max-w-[1400px] mx-auto flex justify-between items-start">
          <div>
            <a href="/">
              <div 
                className="h-10 cursor-pointer font-bold text-2xl"
      ...
      {/* Hero */}
      <section className="bg-white text-black border-t border-black" style={{ padding: "6rem 1.5rem" }}>
      ...
      >
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <a href="/#contact-section">
            <button 
              className="inline-flex items-center justify-center bg-black text-white px-6 py-3 text-sm hover:bg-gray-800 transition-all"
      ...
      {/* Footer */}
      <footer className="bg-white text-black border-t border-gray-300 py-6" style={{ padding: "2rem 1.5rem" }}>
